 ...
 use strict; # force disciplined use of variables
   ...
   { # @ARGV used in scalar context = number of args
	  print "This is more efficient program, should be fast! This program is for CAFA2, combination of three methods! \n";
	  ...
	  print "For example:\n";
	  print "perl $0 ../CAFA_2013_result/F_7_filtered_valid_prediction_by_MHS_and_minig_rules_CAFA2 0.438 ../CAFA_2013_result/F_7_filtered_valid_prediction_by_network_only_CAFA2 0.202 ../CAFA_2013_result/F_7_filtered_valid_prediction_by_sequence_CAFA2 0.251 ../result/F_8_comination_three_scores_CAFA2\n";
	  print "perl $0 ../CAFA_2013_result/F_7_filtered_valid_prediction_by_MHS_and_minig_rules_CAFA2 0.876 ../CAFA_2013_result/F_7_filtered_valid_prediction_by_network_only_CAFA2 0.404 ../CAFA_2013_result/F_7_filtered_valid_prediction_by_sequence_CAFA2 0.502 ../CAFA_2013_result/F_8_comination_three_scores_CAFA2\n";
