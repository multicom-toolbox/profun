...
=cut
 ...
 if(@ARGV!=3)
 {
	 print "This script builds the model 3 for CAFA 2013 only. You can revise the key word and team name inside the scripts. The combination score for MIS, Network based score is used for model3\n";
	 print "perl $0 addr_F_8_MIS_and_network_score_CAFA2013 dir_all_sequences(Downloaded from CAFA website for all targets of CAFA 2014) dir_output\n";
	 print "For example:\n";
	 print "perl $0 ../CAFA_2013_result/F_8_reranged_filtered_valid_prediction_by_MHS_mining_rules_and_network_CAFA2 ../downloaded_testing_from_CAFA/CAFA-2013-targets/all_fasta_file ../CAFA_2013_result/F_9_model3_folder\n";
         print "perl $0 ../CAFA_2013_result/F_8_reranged_filtered_valid_prediction_by_MHS_mining_rules_and_network_for_other_species_CAFA2 ../downloaded_testing_from_CAFA/CAFA-2013-other ../CAFA_2013_result/F_9_model3_for_other_species_folder\n";
 ...
 $key_words[1]="genetic interaction";
 $key_words[2]="genomic context";
 $key_words[3]="de novo prediction";
 $key_words[4]="genetic data";
