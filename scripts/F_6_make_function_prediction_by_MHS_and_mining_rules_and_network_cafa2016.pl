 ...
 sub Mining_rule($$$);              # this function will try to use the mining rules to make prediction
  ...
  if (@ARGV != 8)
    { # @ARGV used in scalar context = number of args
      ...
      print("\n\n***********************************************************\n");
	  print("Examples:\n");
      print "perl $0 ../CAFA_2012_prediction 0.01 ../result/F_4_GO_function_for_all_protein_gene ../result/R_1_mining_rules_from_uniprot/output_s_0.05_c_90 TestSequenceAll ../result/F_5_function_prediction_from_network ../result/F_6_prediction_by_MHS_and_mining_rules_and_network_CAFA1\n";

      print "\nperl $0 ../CAFA_2012_prediction 0.01 ../result/F_4_GO_function_for_all_protein_gene ../result/R_1_mining_rules_from_uniprot/output_s_0.05_c_90 TestSequenceAll ../result/F_5_function_prediction_from_network_including_itself ../result/F_6_prediction_use_itself_GO_statistics_by_MHS_and_mining_rules_and_network_CAFA1\n\n";

      print("perl $PROGRAM_NAME ../test/test_CAFA_prediction 0.01 ../result/F_4_GO_function_for_all_protein_gene ../result/R_1_mining_rules_from_uniprot/Mining_rules TestSequenceAll ../result/F_5_function_prediction_from_network ../result/F_6_prediction_by_MHS_and_mining_and_network_rules\n\n");

      print "perl $0 ../CAFA_2013_data/other 0.01 ../result/F_4_GO_function_for_all_protein_gene ../result/R_1_mining_rules_from_uniprot/Mining_rules TestSequenceAll ../result/F_5_function_prediction_from_network ../CAFA_2013_result/F_6_prediction_by_MHS_and_mining_and_network_rules_for_other_species_CAFA2\n";
   ...
   my($addr_network_function)=$ARGV[5];
   my($output)=$ARGV[6];
   my($dir_tmp)=$ARGV[7];   
...
#print "Mining rule $key ..\n";
	     ...
	     {# we need the protein has network based function prediction
           ...
           for($i=0;$i<@tem_split;$i++)
           {
             ...
             $tem_2[1] = $tem_2[1] * $MHS_score_network;            # times the MHS score, so now they are comparable
 ...
 sub Mining_rule($$$)
 {
	 ...
	 my($mined_result)="NULL"; 
         my($now) = time;
         my($cID) = $now.$$;
         my($tmp_in)="$dir_tmp/tmp.in_$cID";
         my($tmp_out)="$dir_tmp/tmp.out_$cID";
