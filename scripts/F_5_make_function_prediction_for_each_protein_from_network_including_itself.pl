 ...
 sub convert2prob($);        # convert the frequency to prob
  ...
  if (@ARGV != 4)
    { # @ARGV used in scalar context = number of args
	  print "The only difference of this script with F_5_make_function_prediction_for_each_protein_from_network.pl, is in the script, we also use the GO statistics for the hitted protein itself, not only it's neighbours! So this may include more information\n";
      ...
      print("\n\n***********************************************************\n");
	  print("Examples:\n");
      print("perl $PROGRAM_NAME ../result/F_3_protein_lists_with_network_and_one_step_neighbour ../result/F_4_GO_function_for_all_protein_gene ../result/1_go_frequency ../result/F_5_function_prediction_from_network_including_itself\n\n");
