...
=cut
 ...
 if (@ARGV != 3)
    { # @ARGV used in scalar context = number of args
	  ...
	  print "for example:\n";
	  print "perl $0 ../result/F_6_prediction_by_MHS_and_mining_rules_and_network_CAFA1 ../data/go_20130615-termdb.obo-xml ../result/G_filtered_GO_term_for_final_MHS_and_mining_rules_and_network_CAFA1\n";
  
      
      print "perl $0 ../CAFA_2013_result/F_6_prediction_by_sequence_CAFA2 ../data/go_20130615-termdb.obo-xml ../CAFA_2013_result/F_7_filtered_valid_prediction_by_sequence_CAFA2\n";
...
#		   if($tem_2[0]>=1500)
#		   {
#			   #print "Exceed the maximum number 1500 GO terms, skip rest! $line\n";
#			   next;
#		   }
		   $tem_2[0]++;
